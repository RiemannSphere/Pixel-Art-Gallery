...
project: Projekt przejœciowy (PRP)  
# RUN
...
1. Sidebar allows you to navigate between pages.
1. Sidebar offers following options:
    1. LOAD -> loading external artwork
    1. EDIT -> editing artworks' information
    1. DISPLAY -> presenting artworks in a table
    1. MENU -> going back to welcome page
    1. EXIT -> closing program
1. On DISPLAY: comment and rate artworks by choosing artwork and clicking "Comment" button.   
1. On EDIT: choose artwork from list and edit artwork properties in given fields
1. On LOAD: click "Load File" to load your image, then provide info in given fields.  
